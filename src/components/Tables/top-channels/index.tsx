  ...
  return (
    ...
    >
      <h2 className="mb-4 text-body-2xlg font-bold text-dark dark:text-white">
        {t('headers.topChannels')}
      </h2>

      <Table>
        <TableHeader>
          <TableRow className="border-none uppercase [&>th]:text-center">
            <TableHead className="min-w-[120px] !text-left">{t('headers.source')}</TableHead>
            <TableHead>{t('headers.visitors')}</TableHead>
            <TableHead className="!text-right">{t('headers.revenues')}</TableHead>
            <TableHead>{t('headers.sales')}</TableHead>
            <TableHead>{t('headers.conversion')}</TableHead>
          </TableRow>
        </TableHeader>
